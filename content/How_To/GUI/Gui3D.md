...
All controls can also be the target of [behaviors ](https://www.babylonjs.com/features/behaviour) so they expose the associated properties and functions:
...
You can specify the content through the `content` property and set it to any regular [2D GUI content](https://www.babylonjs.com/how_to/gui):
