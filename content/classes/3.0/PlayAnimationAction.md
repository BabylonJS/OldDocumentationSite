...
class [PlayAnimationAction](/classes/3.0/PlayAnimationAction) extends [Action](/classes/3.0/Action)



## Constructor

## new [PlayAnimationAction](/classes/3.0/PlayAnimationAction)(triggerOptions, target, from, to, loop, condition)
...
[Animation](/classes/3.0/Animation) loop or not
