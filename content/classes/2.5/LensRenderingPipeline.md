...
class [LensRenderingPipeline](/classes/2.5/LensRenderingPipeline) extends [PostProcessRenderPipeline](/classes/2.5/PostProcessRenderPipeline)



## Constructor

## new [LensRenderingPipeline](/classes/2.5/LensRenderingPipeline)(name, parameters, scene, ratio, cameras)

@constructor

         * [Effect](/classes/2.5/Effect) parameters are as follow:

{
     ...
     grain_texture: BABYLON.[Texture](/classes/2.5/Texture);     // texture to use for grain effect; if unset, use random B&W noise
...
The chromatic aberration [PostProcess](/classes/2.5/PostProcess) id in the pipeline

@type {string}

### HighlightsEnhancingEffect : string

The highlights enhancing [PostProcess](/classes/2.5/PostProcess) id in the pipeline

@type {string}

### LensDepthOfFieldEffect : string

The depth-of-field [PostProcess](/classes/2.5/PostProcess) id in the pipeline
