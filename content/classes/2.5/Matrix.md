...
### addToRef(other, result) &rarr; [Matrix](/classes/2.5/Matrix)
...
### copyFrom(other) &rarr; [Matrix](/classes/2.5/Matrix)
...
### getRow(index) &rarr; [Vector4](/classes/2.5/Vector4)
...
Rotates a matrix using a [Vector3](/classes/2.5/Vector3)
