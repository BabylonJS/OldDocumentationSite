---
ID_PAGE: 20
PG_TITLE: How to use 3DS Max plugin
---
# Installing the 3DS Max plugin 

The plugin is designed for 3DS Max 2013 or later. To download it, go to the Github project (https://github.com/BabylonJS/Babylon.js), click on the folder _Exporters_, then on the folder _3ds Max_.  
