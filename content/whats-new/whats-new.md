...
- Documentation
  - Entire codebase is now documented. [API documentation](https://www.babylonjs.com/api/)
- GUI
  - New GUI 3D controls toolset. [Complete doc + demos](https://www.babylonjs.com/how_to/gui3d) ([Deltakosh](https://github.com/deltakosh))
  - New GUI control: [Grid](https://www.babylonjs.com/how_to/gui#grid) ([Deltakosh](https://github.com/deltakosh))
  - New GUI control: [InputPassword](https://doc.babylonjs.com/how_to/gui#inputpassword) ([theom](https://github.com/theom))
  - New GUI container [SelectionPanel](https://www.babylonjs.com/how_to/selector) ([JohnK](https://github.com/BabylonJSGuide))
- Gizmo Support ([TrevorDev](https://github.com/TrevorDev))
  - Gizmo and GizmoManager classes used to manipulate meshes in a scene. Gizmo types include: position, scale, rotation and bounding box [Doc](https://www.babylonjs.com/how_to/gizmo) ([TrevorDev](https://github.com/TrevorDev))
  - New behaviors: PointerDragBehavior, SixDofDragBehavior and MultiPointerScaleBehavior to enable smooth drag and drop/scaling with mouse or 6dof controller on a mesh [Doc](https://www.babylonjs.com/how_to/meshbehavior) ([TrevorDev](https://github.com/TrevorDev))
...
- Particle system improvements ([Deltakosh](https://github.com/deltakosh))
  ...
  - Added support for `isBillboardBased`. [Doc](https://www.babylonjs.com/babylon101/particles#alignment)
  ...
  - Added support for noise textures. [Doc](https://www.babylonjs.com/babylon101/particles#noise-texture)
  - Added support for emit rate gradients. [Doc](https://www.babylonjs.com/babylon101/particles#emit-rate-over-time)
  - Added support for ramp gradients. [Doc](https://www.babylonjs.com/babylon101/particles#ramp-gradients)
  - Start size gradient support for particles. [Doc](https://www.babylonjs.com/babylon101/particles#start-size-over-time) ([TrevorDev](https://github.com/TrevorDev))
  - Attached sub emitters. [Doc](https://www.babylonjs.com/how_to/sub_emitters) ([TrevorDev](https://github.com/TrevorDev))
  ...
  - Added support for random start cell when using animated sprite sheets. [Doc](https://www.babylonjs.com/how_to/animate)
...
- Added support for noise procedural textures. [Doc](https://www.babylonjs.com/how_to/how_to_use_procedural_textures#noise-procedural-texture) ([Deltakosh](https://github.com/deltakosh))
...
- Added the choice of [forming a closed loop](https://www.babylonjs.com/how_to/how_to_use_curve3#catmull-rom-spline) to the catmull-rom-spline curve3 ([johnk](https://github.com/babylonjsguide))
...
- New [AnimationGroup class](https://www.babylonjs.com/how_to/group) to control simultaneously multiple animations with different targets ([deltakosh](https://github.com/deltakosh))
- `WebVRCamera`: added basic support for Daydream and Gear VR ([brianzinn](https://github.com/brianzinn))
- Introduced [Projection Texture on SpotLight](https://www.babylonjs.com/babylon101/lights#projection-texture). Demo [here](https://www.babylonjs-playground.com/frame.html#CQNGRK) ([lostink](https://github.com/lostink))
- Introduced support for [local cubemaps](https://www.babylonjs.com/how_to/reflect#using-local-cubemap-mode). Demo [here](https://www.babylonjs-playground.com/frame.html#RNASML#4) ([deltakosh](https://github.com/deltakosh))
- Added [VideoDome](https://www.babylonjs.com/how_to/360videodome) class to easily support 360 videos. Demo [here](https://www.babylonjs-playground.com/frame.html#1E9JQ8#7) ([DavidHGillen](https://github.com/DavidHGillen))
...
- New [AssetContainer](https://www.babylonjs.com/how_to/how_to_use_assetcontainer) class and loading methods ([trevordev](https://github.com/trevordev))
...
- Added support for [animation weights](https://www.babylonjs.com/babylon101/animations#animation-weights). Demo [here](https://www.babylonjs-playground.com/#LL5BIQ) ([deltakosh](https://github.com/deltakosh))
- Added [sub emitters for particle system](https://www.babylonjs.com/babylon101/particles#sub-emitters) which will spawn new particle systems when particles die. Demo [here](https://www.babylonjs-playground.com/frame.html#9NHBCC#1) ([IbraheemOsama](https://github.com/IbraheemOsama))
- New [Babylon.js](https://www.babylonjs.com/resources/maya) and [glTF](https://www.babylonjs.com/resources/maya_to_gltf) exporter for Autodesk Maya ([Noalak](https://github.com/Noalak))
- New [glTF exporter](https://www.babylonjs.com/resources/3dsmax_to_gltf) for Autodesk 3dsmax ([Noalak](https://github.com/Noalak))
- New glTF [serializer](https://www.babylonjs.com/extensions/gltfexporter). You can now export glTF or glb files directly from a Babylon scene ([kcoley](https://github.com/kcoley))
...
- New [particle system emitter shapes](https://www.babylonjs.com/babylon101/particles#shape-emitters): cone and sphere ([IbraheemOsama](https://github.com/IbraheemOsama))
- Added support for 16bits TGA ([deltakosh](https://github.com/deltakosh))
- New `AnimationPropertiesOverride` class used to simplify setting animation properties on child animations. [Documentation](https://www.babylonjs.com/babylon101/animations#overriding-properties) ([deltakosh](https://github.com/deltakosh))
...
- Improved [SceneOptimizer](https://www.babylonjs.com/how_to/how_to_use_sceneoptimizer) to provide better adaptability ([deltakosh](https://github.com/deltakosh))
...
- GUI: Introduced `MultiLine` which will draw lines between any number of meshes, controls and points. [Documentation](https://www.babylonjs.com/how_to/gui#multiline) ([royibernthal](https://github.com/royibernthal))
...
- Added VRExperienceHelper to create WebVR experience with 2 lines of code. [Documentation](https://www.babylonjs.com/how_to/webvr_helper) ([davrous](https://github.com/davrous), [TrevorDev](https://github.com/TrevorDev))
...
- Added support for WebGL context lost and restored events. [Documentation](https://www.babylonjs.com/tutorials/optimizing_your_scene#handling-webgl-context-lost) ([deltakosh](https://github.com/deltakosh))
- Added support for non-pow2 textures when in WebGL2 mode ([deltakosh](https://github.com/deltakosh))
- Engine can now be initialized with an existing WebGL context ([deltakosh](https://github.com/deltakosh))
- Introduced behaviors. [Documentation](https://www.babylonjs.com/overviews/behaviors) ([deltakosh](https://github.com/deltakosh))
- Added support for WebGL Occlusion queries. [Documentation](https://www.babylonjs.com/overviews/occlusionquery) ([Ibraheem Osama](https://github.com/IbraheemOsama))
- New behaviors for ArcRotateCamera. [Documentation](https://www.babylonjs.com/overviews/behaviors) 
...
- New InputText for Babylon.GUI. [Documentation](https://www.babylonjs.com/overviews/gui#inputtext) ([deltakosh](https://github.com/deltakosh))
- New VirtualKeyboard for Babylon.GUI. [Documentation](https://www.babylonjs.com/overviews/gui#virtualkeyboard) ([deltakosh](https://github.com/deltakosh) / [adam](https://github.com/abow))
- Added support for depth pre-pass rendering. [Documentation](https://www.babylonjs.com/tutorials/transparency_and_how_meshes_are_rendered#depth-pre-pass-meshes) ([deltakosh](https://github.com/deltakosh))
- Added support for `material.separateCullingPass`. [Documentation](https://www.babylonjs.com/tutorials/transparency_and_how_meshes_are_rendered#things-to-do-and-not-to-do) ([sebavan](https://github.com/sebavan))
- Added support for Windows Motion Controllers ([Lewis Weaver](https://github.com/leweaver))
- Added support for Particle animation in ParticleSystem. [Documentation](https://www.babylonjs.com/tutorials/particles#particle-animation) ([Ibraheem Osama](https://github.com/IbraheemOsama))
...
- Introduced `NullEngine` which can be used to use Babylon.js in headless mode. [Documentation](https://www.babylonjs.com/generals/nullengine) ([deltakosh](https://github.com/deltakosh))
- New instrumentations tools. [Documentation](https://www.babylonjs.com/how_to/optimizing_your_scene#instrumentation) ([deltakosh](https://github.com/deltakosh))
- Complete rework of Unity3D exporter. [Documentation](https://www.babylonjs.com/resources/intro) ([MackeyK24](https://github.com/MackeyK24))
- Introducing the BabylonJS viewer, an HTML-based 3D/model viewer, with Babylon at its core. [Documentation](https://www.babylonjs.com/extensions/the_babylon_viewer) ([RaananW](https://github.com/RaananW))
...
- Added `MultiObserver`. [Documentation](https://www.babylonjs.com/overviews/observables#multiobserver) ([deltakosh](https://github.com/deltakosh))
...
- New `camera.storeState()` and `camera.restoreState()` functions to store / restore cameras position / rotation / fov. [Documentation](https://www.babylonjs.com/tutorials/cameras#state) ([deltakosh](https://github.com/deltakosh))
...
- Error handling in the Assets Manager was revamped and now also includes a message and an exception (if provided). [Documentation](https://www.babylonjs.com/how_to/how_to_use_assetsmanager#task-state-and-error-handling) ([RaananW](https://github.com/RaananW))
- Asset Task has a state (INIT, RUNNING, DONE and ERROR). [Documentation](https://www.babylonjs.com/how_to/how_to_use_assetsmanager#task-state-and-error-handling) ([RaananW](https://github.com/RaananW))
- Added new options to the physics impostor constructor - ignoreParent and diableBidirectionalTransformation. [Documentation](https://www.babylonjs.com/how_to/using_the_physics_engine#impostors) ([RaananW](https://github.com/RaananW))
...
## Major updates
 - WebGL2 context support. WebGL2 is now used instead of WebGL 1 when available. [More info here](https://www.babylonjs.com/features/webgl2) ([deltakosh](https://github.com/deltakosh))
 - Complete WebVR 1.1 support including controllers for HTC Vive and Oculus. [More info here](https://www.babylonjs.com/features/webvr_camera) ([raanan](https://github.com/raananw) & [davrous](https://github.com/davrous))
 - Complete rewrite of PBRMaterial. Introduced two new helper materials: `pbrMetallicRoughnessMaterial` and `pbrSpecularGlossinessMaterial`. [Demo](https://www.babylonjs.com/demos/pbrglossy/) - [More info here](https://www.babylonjs.com/features/physically_based_rendering) ([Sebastien Vandenberghe](https://github.com/sebavan))
 - Support for Morph Targets. [More info here](https://www.babylonjs.com/How_To/how_to_use_morphtargets) ([deltakosh](https://github.com/deltakosh))
 - New Babylon.GUI to create user interface (compatible with WebVR). [More info here](https://www.babylonjs.com/features/Gui) ([deltakosh](https://github.com/deltakosh))
 ...
 - New DebugLayer. [Doc](https://www.babylonjs.com/features/customize_debug_layer) ([temechon](https://github.com/temechon))
 ...
 - Multi-platform Compressed Textures for Desktops & Mobile Devices with fall back.  Batch (dos) scripts to convert entire directories of .jpg's & .png's [Doc](https://www.babylonjs.com/resources/Multi-Platform_Compressed_Textures) ([jcpalmer](https://github.com/Palmer-JC))
 - All deprecated functions and properties were removed ([deltakosh](https://github.com/deltakosh))
 - New build system based on workloads. [More info here](https://www.babylonjs.com/generals/how_to_start#custom-builds) ([deltakosh](https://github.com/deltakosh))
 ...
 - New image processing postprocess. [Doc here](https://www.babylonjs.com/How_To/how_to_use_postprocesses#imageprocessing) ([deltakosh](https://github.com/deltakosh))
...
- New automatic creation mode for skybox. [Doc here](https://www.babylonjs.com/How_To/environment#automatic-creation) ([deltakosh](https://github.com/deltakosh))
- New way to force compilation of materials. [Doc here](https://www.babylonjs.com/resources/How_materials_work) ([deltakosh](https://github.com/deltakosh))
...
- HDRRenderingPipeline:
  - `HDRRenderingPipeline` has been removed because it is deprecated. It is now replaced by `StandardRenderingPipeline` which is more advanced. See [documentation](https://www.babylonjs.com/How_To/using_standard_rendering_pipeline)
- PBRMaterial:
...
- You can now build your own version of babylon.js with `gulp build-custom` [Doc](https://www.babylonjs.com/generals/how_to_start) ([deltakosh](https://github.com/deltakosh))
...
- StandardMaterial now supports Parallax and Parallax Occlusion Mapping ([tutorial](https://www.babylonjs.com/How_To/Using_parallax_mapping)) ([nockawa](https://github.com/nockawa))
- Animations blending. See [demo here]( https://www.babylonjs-playground.com/#2BLI9T#3). More [info here](https://www.babylonjs.com/How_To/Animations#animation-blending) ([deltakosh](https://github.com/deltakosh))
...
- Added Camera Inputs Manager to manage camera inputs (mouse, touch, keyboard, gamepad, ...) in a composable way, without relying on class inheritance. [Documentation here](https://www.babylonjs.com/How_To/Customizing_Camera_Inputs) ([gleborgne](https://github.com/gleborgne))
- Introduced new observable system to handle events. [Documentation here](https://www.babylonjs.com/features/Observables) ([nockawa](https://github.com/nockawa), [deltakosh](https://github.com/deltakosh))
...
- Introduced Canvas2D feature: a 2D engine to render primitives, sprites in 2D, text. Canvas2D can be displayed in Screen Space (above the 3D scene) or in World Space to be a part of the Scene. [feature](https://www.babylonjs.com/extensions/Using_The_Canvas2D), [tutorial](https://www.babylonjs.com/How_To/Using_the_Canvas2D) ([nockawa](https://github.com/nockawa))
...
- Physics engine was completely rewritten, including both plugins for Oimo.js and Cannon.js. [feature](https://www.babylonjs.com/features/Using_The_Physics_Engine) ([RaananW](https://github.com/RaananW))
...
- Introducing [Materials Library](https://github.com/BabylonJS/Babylon.js/tree/master/materialsLibrary) ([deltakosh](https://github.com/deltakosh))
    - Water material: https://www.babylonjs.com/extensions/Water. [Demo here](https://www.babylonjs.com/Demos/WaterMaterial/) ([julien-moreau](https://github.com/julien-moreau))
    - Fire material: https://www.babylonjs.com/extensions/fire. [Demo here](https://www.babylonjs.com/Demos/FireMaterial/) ([julien-moreau](https://github.com/julien-moreau))
    - Normal material: https://www.babylonjs.com/extensions/normal ([temechon](https://github.com/temechon))
    - Lava Material: https://www.babylonjs.com/extensions/lava ([temechon](https://github.com/temechon))
    - PBR Material: https://www.babylonjs.com/extensions/pbr ([deltakosh](https://github.com/deltakosh))
    - Fur Material: https://www.babylonjs.com/extensions/Fur. [Demo here](https://www.babylonjs.com/Demos/Fur/) ([julien-moreau](https://github.com/julien-moreau))
...
- Support for reflection probes. [See documentation here](https://www.babylonjs.com/How_To/How_to_use_Reflection_probes) ([deltakosh](https://github.com/deltakosh))
...
- Introducing [babylon.core.js](https://www.babylonjs.com/generals/Framework_versions) ([deltakosh](https://github.com/deltakosh))
...
- Meshes can now be attached to bones. See [documentation here](https://www.babylonjs.com/How_To/How_to_use_Bones_and_Skeletons) and [sample here]( https://www.babylonjs-playground.com/#11BH6Z#18) ([deltakosh](https://github.com/deltakosh))
...
- SIMD.js support for math library. See [demo](https://www.babylonjs.com/scenes/simd.html) ([deltakosh](http://www.github.com/deltakosh))
...
- New ```Mesh.CreateDecal()``` function to create decals. See [demo](https://www.babylonjs.com/?DECALS). More info [here](https://www.babylonjs.com/page.php?p=25094) ([deltakosh](http://www.github.com/deltakosh))
- New tool for debugLayer: You can now dump renderTargets to see their content ([deltakosh](http://www.github.com/deltakosh))
- Complete shadows code rework: New bias property for ShadowGenerator, new orthogonal shadows for directional shadows, automatic projection size for directional lights, new BlurVarianceShadowMap filter. See [demo](https://www.babylonjs.com/?SOFTSHADOWS). Documentation updated [here](https://www.babylonjs.com/How_To/shadows) ([deltakosh](http://www.github.com/deltakosh))
- New lens effects rendering pipeline. More info [here](https://www.babylonjs.com/page.php?p=24841) ([jahow](https://github.com/jahow))
- New basic mesh type: Ribbons. See [demo](https://www.babylonjs.com/?RIBBONS). More info [here](https://www.babylonjs.com/page.php?p=25088) ([jbousquie](https://github.com/jbousquie))
- New ```BABYLON.Mesh.ExtrudeShape``` and ```BABYLON.Mesh.ExtrudeShapeCustom```. More info [here](https://www.babylonjs.com/page.php?p=24847) ([jbousquie](https://github.com/jbousquie))
- New Loaders folder with a first additionnal plugin: [STL](https://www.babylonjs.com/page.php?p=25109)  ([raananw](http://www.github.com/raananw), [deltakosh](http://www.github.com/deltakosh))
...
- Added the ability [to dynamically update or to morph](https://www.babylonjs.com/page.php?p=25096) an mesh instance ([jbousquie](https://github.com/jbousquie))
...
- New basic mesh type: Tube. More info [here](https://www.babylonjs.com/page.php?p=24847) ([jbousquie](https://github.com/jbousquie))
...
- New ```Curve``` object ([jbousquie](https://github.com/jbousquie)) More info [here](https://www.babylonjs.com/page.php?p=25091)
- New ```Path3D``` object ([jbousquie](https://github.com/jbousquie)) More info [here](https://www.babylonjs.com/page.php?p=25090)
...
### Major updates
 - Support for WebAudio. More info [here](https://www.babylonjs.com/page.php?p=24824) ([davrous](http://www.github.com/davrous))
 - Support for Procedural Texture with standard usable samples and custom support. More info [here](https://www.babylonjs.com/page.php?p=22601) ([meulta](http://www.github.com/meulta))
 ...
 - New ```Mesh.simplify()``` function to automatically simplify meshes. More info [here](https://www.babylonjs.com/page.php?p=24822) ([raananw](http://www.github.com/raananw))
 - New ```scene.enableDepthRenderer()``` to register depth texture rendering. More info [here](https://www.babylonjs.com/page.php?p=24825) ([deltakosh](http://www.github.com/deltakosh))
 - New ```SSAORenderingPipeline``` to apply screen space ambient occlusion. More info [here](https://www.babylonjs.com/page.php?p=24837) ([julien-moreau](http://www.github.com/julien-moreau)) 
 - New ```VolumetricLightScatteringPostProcess``` to simulate volumetric light scattering. More info [here](https://www.babylonjs.com/page.php?p=24840) ([julien-moreau](http://www.github.com/julien-moreau)) 
...
### Updates
 ...
 - You can now define if OnIntersectionEnterTrigger and OnIntersectionExitTrigger may use precise intersections. More info [here](https://www.babylonjs.com/page.php?p=22531) ([deltakosh](http://www.github.com/deltakosh))
...
### Major updates
 ...
 - Fresnel support for diffuse, emissive, opacity and reflection on ```StandardMaterial```. See [demo here](https://www.babylonjs.com/?FRESNEL) and [wiki here](https://github.com/BabylonJS/Babylon.js/wiki/How-to-use-FresnelParameters%3F) ([deltakosh](http://www.github.com/deltakosh))
...
### Updates
 ...
 - New ```effect``` parameter to define custom shader for ```BABYLON.ParticleSystem``` constructor. See [demo here](https://www.babylonjs.com/?PARTICLES2) and [wiki here](https://github.com/BabylonJS/Babylon.js/wiki/12-Particles) ([deltakosh](http://www.github.com/deltakosh)) 
 ...
 - New feature demo for [custom render target texture](https://www.babylonjs.com/?CUSTOMRENDERTARGET) ([deltakosh](http://www.github.com/deltakosh)) 
...
### Updates
 ...
 - New mesh type: ```BABYLON.LinesMesh```. You can find a [demo here](https://www.babylonjs.com/?LINES) ([deltakosh](http://www.github.com/deltakosh)) 
...
### Major updates
 ...
 - Babylon.js Playground: Experiment and learn Babylon.js using the [playground](https://www.babylonjs.com/playground) ([deltakosh](http://www.github.com/deltakosh))
...
### Major updates
 ...
 - New ```BABYLON.ShaderMaterial``` object to simply create custom shaders ([deltakosh](http://www.github.com/deltakosh)) - See [Custom shader - cell shading](https://www.babylonjs.com/index.html?CUSTOMSHADER)
 - New ```BABYLON.VertexData``` object to easily manipulates vertex attributes ([deltakosh](http://www.github.com/deltakosh)) - See [VertexData](https://www.babylonjs.com/index.html?CLOUDS)
...
### Major updates
 ...
 - Support for [physics engine](https://www.babylonjs.com/index.html?PHYSICS) thanks to cannon.js ([deltakosh](http://www.github.com/deltakosh))
 - New [sandbox tool](https://www.babylonjs.com/sandbox/) ([davrous](http://www.github.com/davrous))
...
### Updates
 ...
 - Cameras now supports animations (see https://www.babylonjs.com/index.html?TRAIN) ([deltakosh](http://www.github.com/deltakosh)) 
