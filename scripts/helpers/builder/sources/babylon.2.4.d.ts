declare module BABYLON {
    ...
    class Engine {
        ...
        updateDynamicVertexBuffer(vertexBuffer: WebGLBuffer, vertices: number[], offset?: number): void;
...
declare module BABYLON {
    ...
    class Tools {
        ...
        static ExtractMinAndMax(positions: number[], start: number, count: number, bias?: Vector2): {
            minimum: Vector3;
            maximum: Vector3;
        };
...
declare module BABYLON {
    class VideoTexture extends Texture {
         ...
         */
        constructor(name: string, urlsOrVideo: string[], scene: Scene, generateMipMaps?: boolean, invertY?: boolean, samplingMode?: number);
