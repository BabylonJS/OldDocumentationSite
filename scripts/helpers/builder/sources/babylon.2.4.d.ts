...
declare module BABYLON {
    ...
    function instanceData<T>(category?: string, shaderAttributeName?: string): (target: Object, propName: string , descriptor: TypedPropertyDescriptor<T>) => void;
...
declare module BABYLON {
    ...
    function dynamicLevelProperty<T>(propId: number, piStore: (pi: Prim2DPropInfo) => void, typeLevelCompare?: boolean, dirtyBoundingInfo?: boolean): (target: Object, propName: string , descriptor: TypedPropertyDescriptor<T>) => void;
}
...
declare module BABYLON {
    function serialize(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsTexture(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsColor3(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsFresnelParameters(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsVector2(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsVector3(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsMeshReference(sourceName?: string): (target: any, propertyKey: string ) => void;
    function serializeAsColorCurves(sourceName?: string): (target: any, propertyKey: string ) => void;
